...
It is also possible to run MCMC for the latent values with the optimized hyperparameters. To use more than one core for the computation, uncomment the first line.
```{r, results='hide'}
...
As we see, the EP algorithm gives very accurate approximation and similar fit compared to the MCMC.
